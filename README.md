...
The skill automatically routes user requests to the appropriate chart generation path — constructing ECharts option JSON and outputting self-contained HTML by default, or using CLI for SVG/PNG export when an image format is requested.
